...
DATAFILES_NORTH = [
    'data/9800X7003HZY-2018-11.csv',
    'data/9800X7003HZY-2018-12.csv',
    'data/9800X7003HZY-2019-01.csv',
    'data/9800X7003HZY-2019-02.csv',
    'data/9800X7003HZY-2019-03.csv',
    'data/9800X7003HZY-2019-04.csv',
    'data/9800X7003HZY-2019-05.csv',
    'data/9800X7003HZY-2019-06.csv',
    'data/9800X7003HZY-2019-07.csv',
    'data/9800X7003HZY-2019-08.csv',
    'data/9800X7003HZY-2019-09.csv',
    'data/9800X7003HZY-2019-10.csv',
]

DATAFILES_SOUTH = [
    'data/9800YU0FYRKZ-2018-11.csv',
    'data/9800YU0FYRKZ-2018-12.csv',
    'data/9800YU0FYRKZ-2019-01.csv',
    'data/9800YU0FYRKZ-2019-02.csv',
    'data/9800YU0FYRKZ-2019-03.csv',
    'data/9800YU0FYRKZ-2019-04.csv',
    'data/9800YU0FYRKZ-2019-05.csv',
    'data/9800YU0FYRKZ-2019-06.csv',
    'data/9800YU0FYRKZ-2019-07.csv',
    'data/9800YU0FYRKZ-2019-08.csv',
    'data/9800YU0FYRKZ-2019-09.csv',
    'data/9800YU0FYRKZ-2019-10.csv',
]
...
def get_drakewell_data():
    ...
    df = pd.merge(df_north, df_south, on='timestamp', how='outer', suffixes=('_north', '_south'))
...
def do_boxplot(df, by, column, xlabel, ymax, title, savefile, labels=[], hod=False):
    ...
    fig.suptitle('Milton Road Bluetruth Journey Times\n(A14 to Arbury Rd/Union Ln, Nov 2018-Oct 2019, 07:30-09:30)')
...
do_histplot(df_sample.minutes, 60, 15, 'All journeys', 'drakewell-hist.pdf')
...
do_boxplot(
    df_sample, 100*df_sample.index.hour+df_sample.index.minute, 'minutes',
    'Time of Day', YMAX, 'Journeys by time of day',
    'drakewell-tod.pdf', hod=True)
...
do_boxplot(
    ...
    'drakewell-month.pdf', labels=months)
